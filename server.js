...
app.post('/api/generate-tasks', async (req, res) => {
    ...
    await handleApiCall(res, () => ai.models.generateContent({
...
app.post('/api/chat-response', async (req, res) => {
    ...
    await handleTextApiCall(res, () => ai.models.generateContent({ model: 'gemini-2.5-flash', contents: prompt }));
});
...
app.post('/api/support-chat-response', async (req, res) => {
    ...
    await handleTextApiCall(res, () => ai.models.generateContent({
        model: 'gemini-2.5-flash',
